...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/28 15:35:56 by a17641238         #+#    #+#             */
/*   Updated: 2020/09/29 16:50:43 by a17641238        ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		rsa_put_priv_der(int output_fd, const t_rsa_priv_key *in)
{
	...
	total_size = rsa_priv_to_der_string(in, arr);
...
int		rsa_put_pub_der(int output_fd, const t_rsa_pub_key *in)
{
	...
	total_size = rsa_public_to_der_string(in, result);
