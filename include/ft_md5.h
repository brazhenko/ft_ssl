...
# define R2	ROUND2(hsh.a, hsh.b, hsh.c, hsh.d, buffer[1], 5, 17); \
...
# define R3	ROUND3(hsh.a, hsh.b, hsh.c, hsh.d, buffer[5], 4, 33); \
...
# define R4	ROUND4(hsh.a, hsh.b, hsh.c, hsh.d, buffer[0], 6, 49); \
