...
# define ROUND1(a, b, c, d, xk, s, i) \
	a = b + LROT(a + FUNC_F(b, c, d) + xk + md5_constants[i-1], s);

# define ROUND2(a, b, c, d, xk, s, i) \
	a = b + LROT(a + FUNC_G(b, c, d) + xk + md5_constants[i-1], s);

# define ROUND3(a, b, c, d, xk, s, i) \
	a = b + LROT(a + FUNC_H(b, c, d) + xk + md5_constants[i-1], s);

# define ROUND4(a, b, c, d, xk, s, i) \
	a = b + LROT(a + FUNC_I(b, c, d) + xk + md5_constants[i-1], s);


static const unsigned md5_constants[64] = {
